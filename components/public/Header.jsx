            ...
            <nav
                ...
                <div className="px-4 md:px-8 py-4 flex items-center justify-between max-w-400 mx-auto">
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <a href="./index.html"
                            className="text-xs font-bold text-gray-100 uppercase hover:text-yellow-300 transition duration-300">Movies</a>
                        <a href="./admin.html"
                            className="text-xs font-bold text-gray-100 uppercase hover:text-yellow-300 transition duration-300">Admin</a>
                    </div>
                    ...
                    <div className="flex flex-col px-4 py-4 space-y-4">
                        <a href="#"
                            className="text-sm font-bold text-gray-100 uppercase hover:text-yellow-300 transition duration-300"><i
                                className="fa-solid fa-gamepad mr-2"></i>Games</a>
                        <a href="#"
                            className="text-sm font-bold text-gray-100 uppercase hover:text-yellow-300 transition duration-300">Assets</a>
                        <a href="#"
                            className="text-sm font-bold text-gray-100 uppercase hover:text-yellow-300 transition duration-300">Movies</a>
                    </div>
                </div>
            </nav>
